	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{ URL::route('admin') }}"> <img alt="Charisma Logo" src="{{URL::asset('assets/admin/img/logo20.png') }}" /> <span>Charisma</span></a>
		...
		<div class="span2 main-menu-span">
			<div class="well nav-collapse sidebar-nav">
				<ul class="nav nav-tabs nav-stacked main-menu">
					...
					<li><a class="ajax-link" href="{{URL::route('admin')}}"><i class="icon-home"></i><span class="hidden-tablet"> Dashboard</span></a></li>
					<li><a class="ajax-link" href="{{URL::route('admin/users')}}"><i class="icon-user"></i><span class="hidden-tablet">Users</span></a></li>
				</ul>
