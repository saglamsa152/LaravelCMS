...
<?= link_to_action( 'AdminController@getIndex', Option::getOption('siteName'), '', array( 'class' => 'logo' ) ) ?>
		...
		<li>
			...
			<ul class="menu">
				...
				<li>
					<a href="#">
						<div class="pull-left">
							<?= HTML::image( 'assets/admin/img/avatar2.png', 'User Image', array( 'class' => 'img-circle' ) ) ?>
						</div>
						<h4>
				...
				<li>
					<a href="#">
						<div class="pull-left">
							<?= HTML::image( 'assets/admin/img/avatar.png', 'User Image', array( 'class' => 'img-circle' ) ) ?>
						</div>
						<h4>
							Developers
