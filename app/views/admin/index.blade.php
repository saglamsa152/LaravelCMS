...
<div>
	<ul class="breadcrumb">
		<li>
			<a href="#"><?php echo _('Home')?></a> <span class="divider">/</span>
		</li>
		<li>
			<a href="#"><?php echo _('Dashboard')?></a>
		</li>
	</ul>
</div>
<div class="sortable row-fluid">
	<a data-rel="tooltip" title="6 new members." class="well span3 top-block" href="#">
		...
		<div><?php echo _('Total Members')?></div>
		<div>507</div>
	...
	<a data-rel="tooltip" title="4 new pro members." class="well span3 top-block" href="#">
		...
		<div><?php echo _('Pro Members')?></div>
		<div>228</div>
