...
<div class="box box-success">
	...
	<div class="box-body chat" id="chat-box">
		<!-- chat item -->
		<div class="item">
			<?=HTML::image('assets/admin/img/avatar.png','user image',array('class'=>'online'))?>
		...
		<!-- chat item -->
		<div class="item">
			<?=HTML::image('assets/admin/img/avatar2.png','user image',array('class'=>'offline'))?>
		...
		<!-- chat item -->
		<div class="item">
			<?=HTML::image('assets/admin/img/avatar3.png','user image',array('class'=>'offline'))?>
