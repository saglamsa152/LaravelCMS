	...
	<section class="content">
		<?php if ( $errors->count() > 0 ):
			...
			<div class="error-content">
				<h3><?=$error?></h3>
				<a href="#" onclick="history.back()" class="btn btn-primary"><i class="fa fa-reply"></i></a>
				<a href="<?=URL::action('AdminController@getIndex')?>" class="btn btn-primary"><i class="fa fa-dashboard"></i></a>
			</div><!-- /.error-content -->
		</div><!-- /.error-page -->
			<?php endforeach;
		endif?>
