...
// language
						...
						<div class="row-fluid">
							<div class="span4 half">
								...
								<?php if ( $create_text_files ) { ?>
									<button class="tip btn create-file-btn" title="<?php echo lang_New_File; ?>"><i class="icon-plus"></i><i class="icon-file"></i>
									</button>
								<?php } ?>
								...
								<?php if ( $copy_cut_files || $copy_cut_dirs ) { ?>
									<button class="tip btn paste-here-btn" title="<?php echo lang_Paste_Here; ?>">
										<i class="rficon-clipboard-apply"></i></button>
									<button class="tip btn clear-clipboard-btn" title="<?php echo lang_Clear_Clipboard; ?>">
							...
							<div class="span2 half view-controller">
								...
								<button class="btn tip<?php if ( $view == 1 ) echo " btn-inverse"; ?>" id="view1" data-value="1" title="<?php echo lang_View_list; ?>">
									<i class="icon-align-justify <?php if ( $view == 1 ) echo "icon-white"; ?>"></i></button>
							...
							<div class="span6 half types">
								...
								<?php } ?>
								<input accesskey="f" type="text" class="filter-input <?php echo( ( $_GET['type'] != 1 && $_GET['type'] != 3 ) ? '' : 'filter-input-notype' ); ?>" id="filter-input" name="filter" placeholder="<?php echo fix_strtolower( lang_Text_filter ); ?>..." value="<?php echo $filter; ?>" /><?php if ( $n_files > $file_number_limit_js ) { ?>
	...
	<div class="row-fluid">
		...
		<ul class="breadcrumb">
			...
			<li class="pull-right">
				<a class="btn-small" href="javascript:void('')" id="change_lang_btn"><i class="icon-globe"></i></a></li>
			<li class="pull-right">
		...
		<figure data-name="<?php echo $file ?>" data-type="<?php if ( $is_img ) {
			...
			<figcaption>
				<form action="force_download.php" method="post" class="download-form" id="form<?php echo $nu; ?>">
					...
					<?php }
					elseif ( $preview_text_files === TRUE && in_array( $extension_lower, $previewable_text_file_exts ) ) { ?>
