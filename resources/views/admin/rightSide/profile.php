				...
				<section class="col-md-9 clearfix">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a data-toggle="tab" href="#profile"><?= _( 'Profile' ) ?></a></li>
							<li><a data-toggle="tab" href="#dues"></i> <?= _( 'Dues' ) ?> </a>
							</li>
						</ul>
						<div class="tab-content">
							...
							<div id="dues" class="tab-pane">
          					...
          					<span class="input-group-addon white">
								...
								<div class="clearfix"></div>
								<?= Form::submit( _( 'Pay' ), array( 'class' => 'btn btn-primary pull-right' ) ) ?>
								<div class="clearfix"></div>
								<?=Form::close()?>
							</div>
						</div><!-- /.tab-content-->
