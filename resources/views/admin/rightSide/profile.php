				...
				<div class="box-body">
					...
					<div class="form-group col-md-6">
						...
						<div class="input-group col-md-8">
							...
							<?= Form::text( 'created_at', $user->created_at, array( 'class' => 'form-control ', 'data-inputmask' => '"alias": "yyyy-mm-dd"', 'data-mask' => '' ) ) ?>
						</div><!-- /.input group -->
					</div><!-- /.form group -->
					...
					<div class="form-group col-md-6">
						...
						<div class="input-group col-md-8">
							...
							<?= Form::text( 'meta[gsm]', $user->gsm, array( 'class' => 'form-control ', 'data-inputmask' => '"mask": "0(999) 999 99 99"', 'data-mask' => '' ) ) ?>
						</div><!-- /.input group -->
					</div><!-- /.form group -->
					...
					<div class="form-group col-md-6">
						...
						<div class="input-group col-md-8">
							...
							<?= Form::text( 'meta[phone]', $user->phone, array( 'class' => 'form-control ', 'data-inputmask' => '"mask": "0(999) 999 99 99"', 'data-mask' => '' ) ) ?>
						</div><!-- /.input group -->
					</div><!-- /.form group -->
