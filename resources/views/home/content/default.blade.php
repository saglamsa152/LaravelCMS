<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - September08, 2014!</div>
    <div class="camera-wrapper">
        <div id="camera" class="camera-wrap">
            <div data-src="{{URL::asset('assets/home/images/index_slide01.jpg')}}">
                <div class="fadeIn camera_caption">
                    <h2 class="text_1 color_1">Solutions that you need!</h2>
                    <a class="btn_1" href="#">More info</a>
                </div>
            </div>
            <div data-src="{{URL::asset('assets/home/images/index_slide02.jpg')}}">
                <div class="fadeIn camera_caption">
                    <h2 class="text_1 color_1">Lorem ipsum dolor sit!</h2>
                    <a class="btn_1" href="#">More info</a>
                </div>
            </div>
            <div data-src="{{URL::asset('assets/home/images/index_slide03.jpg')}}">
                <div class="fadeIn camera_caption">
    ...
    <div class="container">
        <div class="row wrap_1">
            <div class="grid_6">
                <div class="wrap_6">
                    <div class="box_2 maxheight2">
                        <div class="put-left"><?= Html::image('assets/home/images/index_img01.png','Image 1')?></div>
                        <div class="caption">
            ...
            <div class="grid_6">
                <div class="wrap_6">
                    <div class="box_2 maxheight2">
                        <div class="put-left"><?= Html::image('assets/home/images/index_img02.png','Image 2')?></div>
                        <div class="caption">
                            <h3 class="text_2 color_2">
                                The Highest <br/>
                                Quality Services
