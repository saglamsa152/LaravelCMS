                ...
                <div class="grid_12">
                    <div class="isotope row">
                        <div class="element-item grid_4 c1">
                            <div class="box_7">
                                <div class="img-wrap">
                                    <?= Html::image('assets/home/images/index-2_img01.jpg' ,'Image 1')?>
                                </div>
                                <div class="caption">
                        ...
                        <div class="element-item grid_4 c1">
                            <div class="box_7">
                                <div class="img-wrap">
                                    <?= Html::image('assets/home/images/index-2_img02.jpg' ,'Image 2')?>
                                </div>
                                <div class="caption">
                        ...
                        <div class="element-item grid_4 c1">
                            <div class="box_7">
                                <div class="img-wrap">
                                    <?= Html::image('assets/home/images/index-2_img03.jpg' ,'Image 3')?>
                                </div>
                                <div class="caption">
                        ...
                        <div class="element-item grid_4 c2">
                            <div class="box_7">
                                <div class="img-wrap">
                                    <?= Html::image('assets/home/images/index-2_img04.jpg' ,'Image 4')?>
                                </div>
                                <div class="caption">
                        ...
                        <div class="element-item grid_4 c2">
                            <div class="box_7">
                                <div class="img-wrap">
                                    <?= Html::image('assets/home/images/index-2_img05.jpg' ,'Image 5')?>
                                </div>
                                <div class="caption">
                                    <h3 class="text_2 color_2"><a href="#">Tertomino verto</a></h3>
                                    <p class="text_3">
                        ...
                        <div class="element-item grid_4 c3">
                            <div class="box_7">
                                <div class="img-wrap">
                                    <?= Html::image('assets/home/images/index-2_img06.jpg' ,'Image 6')?>
                                </div>
                                <div class="caption">
